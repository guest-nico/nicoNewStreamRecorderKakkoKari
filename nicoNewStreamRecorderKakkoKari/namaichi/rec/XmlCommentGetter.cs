...
namespace namaichi.rec
{
	...
	public class XmlCommentGetter
	{
		...
		public XmlCommentGetter(string lvid, 
		...
		private void heartBeater() {
			while (rm.rfu == rfu) {
				try {
					...
					util.debugWriteLine(e.Message+e.StackTrace + e.Source + e.TargetSite + util.getMainSubStr(true, true));
				}
				Thread.Sleep(60000);
