...
namespace namaichi
{
	partial class optionForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.isOnlyTimeShiftChaseChkBox = new System.Windows.Forms.CheckBox();
			...
			// tabPage8
			// 
			this.tabPage8.Controls.Add(this.commentReplaceList);
			...
			this.commentReplaceList.TabIndex = 15;
			...
			this.displayGroup.Size = new System.Drawing.Size(372, 65);
			...
			// groupBox17
			// 
			this.groupBox17.Controls.Add(this.isCommentFileChangeOnFileAddedChkBox);
			this.groupBox17.Controls.Add(this.commentReplaceText);
			this.groupBox17.Controls.Add(this.commentReplaceEditBtn);
			...
			this.groupBox17.Size = new System.Drawing.Size(407, 175);
			...
			this.isCommentFileChangeOnFileAddedChkBox.TabIndex = 15;
			...
			this.commentReplaceText.Location = new System.Drawing.Point(296, 82);
			...
			this.commentReplaceText.Visible = false;
			...
			this.commentReplaceEditBtn.TabIndex = 1;
			...
			// groupBox11
			// 
			this.groupBox11.Controls.Add(this.isArgChaseRecFromFirstChkBox);
			this.groupBox11.Controls.Add(this.label3);
			this.groupBox11.Controls.Add(this.isOnlyTimeShiftChaseChkBox);
			this.groupBox11.Controls.Add(this.isRealTimeRecordRadioBtn);
			this.groupBox11.Controls.Add(this.isChaseRecordRadioBtn);
			this.groupBox11.Location = new System.Drawing.Point(5, 10);
			this.groupBox11.Name = "groupBox11";
			this.groupBox11.Size = new System.Drawing.Size(385, 185);
			this.groupBox11.TabIndex = 1;
			this.groupBox11.TabStop = false;
			this.groupBox11.Text = "リアルタイム録画";
			// 
			...
			this.label3.Text = "(追っかけ再生の録画はセグメント抜けが起こらないはずですが、リアルタイム放送から数秒以上遅れて配信されているため、追っかけ再生を録画中に放送が終了すると一旦接続が" +
			"切断されます。タイムシフトに接続できた場合は自動で続きをタイムシフトで録画しますが、タイムシフトに接続できなかった場合は終了直前の動画データが取得できなくなりま" +
			"す。)";
			// 
			// isOnlyTimeShiftChaseChkBox
			// 
			this.isOnlyTimeShiftChaseChkBox.Location = new System.Drawing.Point(32, 85);
			this.isOnlyTimeShiftChaseChkBox.Name = "isOnlyTimeShiftChaseChkBox";
			this.isOnlyTimeShiftChaseChkBox.Size = new System.Drawing.Size(309, 15);
			this.isOnlyTimeShiftChaseChkBox.TabIndex = 1;
			this.isOnlyTimeShiftChaseChkBox.Text = "タイムシフトに対応した放送のみ追っかけ再生から取得する";
			this.isOnlyTimeShiftChaseChkBox.UseVisualStyleBackColor = true;
			// 
			...
			// groupBox15
			// 
			this.groupBox15.Controls.Add(this.useProxyChkBox);
			this.groupBox15.Controls.Add(this.proxyPortLabel);
			this.groupBox15.Controls.Add(this.proxyAddressLabel);
			this.groupBox15.Controls.Add(this.proxyPortText);
			this.groupBox15.Controls.Add(this.proxyAddressText);
			...
			this.groupBox13.Location = new System.Drawing.Point(5, 255);
			...
			this.secondRecFolderSanshouBtn.TabIndex = 1;
			...
			this.secondRecFolderText.TabIndex = 21;
			// 
			// comIDRadioBtn
			// 
			...
			this.useSecondRecFolderChk.TabIndex = 2;
